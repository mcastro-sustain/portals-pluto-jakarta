...
import static jakarta.portlet.tck.beans.JSR286SpecTestCaseDetails.V2ADDLPORTLETTESTS_SPEC2_6_RENDERCONFIG3_GETRESOURCEBUNDLE5;
import static jakarta.portlet.tck.beans.JSR286SpecTestCaseDetails.V2ADDLPORTLETTESTS_SPEC2_6_RENDERCONFIG3_GETRESOURCEBUNDLE6;
import static jakarta.portlet.tck.beans.JSR286SpecTestCaseDetails.V2ADDLPORTLETTESTS_SPEC2_6_RENDERCONFIG3_GETRESOURCEBUNDLE7;
...
public class AddlPortletTests_SPEC2_6_RenderConfig3 implements Portlet {
  ...
  public void render(RenderRequest portletReq, RenderResponse portletResp)
    ...
    /* \"jakarta.portlet.title\" property, the value defined in the */
    ...
    if (res.getString("jakarta.portlet.title").equals("AddlPortletTests_SPEC2_6_RenderConfig3")) {
      tr0.setTcSuccess(true);
    } else {
      tr0.appendTcDetail("Failed because title is " + res.getString("jakarta.portlet.title"));
    }
    tr0.writeTo(writer);
    ...
    if (res.getString("jakarta.portlet.keywords")
        .equals("AddlPortletTests_SPEC2_6_RenderConfig3_b")) {
      tr2.setTcSuccess(true);
    } else {
      tr2.appendTcDetail("Failed because keyword is " + res.getString("jakarta.portlet.keywords"));
    }
    tr2.writeTo(writer);
