...
import static jakarta.portlet.tck.beans.JSR286ApiTestCaseDetails.V2REQUESTTESTS_ACTIONREQUEST_APIACTION_FIELDACTION_NAME;
...
public class RequestTests_ActionRequest_ApiAction implements Portlet, ResourceServingPortlet {
   ...
   public void processAction(ActionRequest portletReq, ActionResponse portletResp)
      ...
      try {
         tr0.setTcSuccess(cc.hasField("ACTION_NAME", "jakarta.portlet.action"));
