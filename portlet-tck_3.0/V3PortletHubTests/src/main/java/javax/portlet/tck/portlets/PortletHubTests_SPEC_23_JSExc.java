...
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION2;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION3;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION4;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION5;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION6;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION7;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTION8;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ACTIONA;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER2;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER3;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER4;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER5;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER6;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER7;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_ADDEVENTLISTENER8;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_CREATERESOURCEURL1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_CREATERESOURCEURL2;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_CREATERESOURCEURL3;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_REMOVEEVENTLISTENER1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_REMOVEEVENTLISTENER2;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_REMOVEEVENTLISTENER3;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_REMOVEEVENTLISTENER4;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_REMOVEEVENTLISTENER5;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATE1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATE2;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATE3;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATE4;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATE5;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATE6;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATE7;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATE9;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATEA;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_SETRENDERSTATEB;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_STARTPARTIALACTION1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_STARTPARTIALACTION2;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_STARTPARTIALACTION3;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSEXC_STARTPARTIALACTION4;
