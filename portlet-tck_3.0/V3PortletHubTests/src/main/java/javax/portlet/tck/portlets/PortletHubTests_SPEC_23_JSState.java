...
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_CLONE;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_CLONE1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_CLONE2;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_CLONE3;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_CLONE4;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_CLONE5;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_CLONE6;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_CLONE7;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETPORTLETMODE;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETPORTLETMODE1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETVALUE;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETVALUE1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETVALUE2;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETVALUE3;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETVALUE4;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETVALUE5;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETVALUE6;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETVALUES;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETVALUES1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETVALUES2;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETVALUES3;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETVALUES4;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETWINDOWSTATE;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_GETWINDOWSTATE1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_PARAMETERS;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_PARAMETERS1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_PARAMETERS2;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_PARAMETERS3;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_PORTLETMODE;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_REMOVE;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_REMOVE1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_REMOVE2;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_SETPORTLETMODE;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_SETPORTLETMODE1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_SETPORTLETMODE2;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_SETVALUE;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_SETVALUE1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_SETVALUE2;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_SETVALUE3;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_SETVALUE4;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_SETVALUE5;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_SETWINDOWSTATE;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_SETWINDOWSTATE1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_SETWINDOWSTATE2;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_STATE1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_STATE2;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_STATE3;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3PORTLETHUBTESTS_SPEC_23_JSSTATE_WINDOWSTATE;
