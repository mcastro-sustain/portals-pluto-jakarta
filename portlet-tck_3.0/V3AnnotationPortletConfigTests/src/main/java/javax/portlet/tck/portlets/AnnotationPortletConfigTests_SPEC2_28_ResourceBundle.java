...
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3ANNOTATIONPORTLETCONFIGTESTS_SPEC2_28_RESOURCEBUNDLE_DECLARINGRESOURCEBUNDLE1;
import static jakarta.portlet.tck.util.ModuleTestCaseDetails.V3ANNOTATIONPORTLETCONFIGTESTS_SPEC2_28_RESOURCEBUNDLE_DECLARINGRESOURCEBUNDLE2;
...
@PortletConfiguration(
   ...
   resourceBundle = "jakarta.portlet.tck.portlets.resource",
...
public class AnnotationPortletConfigTests_SPEC2_28_ResourceBundle implements Portlet {
   ...
   public void render(RenderRequest portletReq, RenderResponse portletResp) throws PortletException, IOException {
      ...
      /* PortletConfig object."                                                     */
      {
         ...
         if(res.containsKey("jakarta.portlet.title")
               && res.getString("jakarta.portlet.title")
             .equals("AnnotationPortletConfigTests_SPEC2_28_ResourceBundle2")){
            result.setTcSuccess(true);
         } else {
            result.appendTcDetail("Failed because portlet title is not AnnotationPortletConfigTests_SPEC2_28_ResourceBundle2 but "+res.getString("jakarta.portlet.title"));
         }
