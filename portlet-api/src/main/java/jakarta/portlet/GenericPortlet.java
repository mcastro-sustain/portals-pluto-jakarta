...
public abstract class GenericPortlet implements Portlet, PortletConfig, EventPortlet, ResourceServingPortlet, HeaderPortlet {
    ...
    * <P>
    * The value is <code>"jakarta.portlet.automaticResourceDispatching"</code>.
    * </div>
    * 
    * @since 3.0
    */
   public static final String AUTOMATIC_RESOURCE_DISPATCH = "jakarta.portlet.automaticResourceDispatching";
   ...
   public void render(RenderRequest request, RenderResponse response) throws PortletException, java.io.IOException {
		...
		if (renderPartAttrValue != null) {
			...
			if (renderPartAttrValue.equals(RenderRequest.RENDER_HEADERS)) {
				...
				throw new PortletException("Unknown value of the 'jakarta.portlet.render_part' request attribute");
			}
		} else {
	 ...
	 * 'jakarta.portlet.title' resource name.
	 * <p>
	...
	protected java.lang.String getTitle(RenderRequest request) {
		...
		return config.getResourceBundle(request.getLocale()).getString("jakarta.portlet.title");
	}
	 ...
	 * to be allowed to be called by <code>GenericPortlet</code>.
	 * 
	 * @see jakarta.portlet.EventPortlet#processEvent(jakarta.portlet.EventRequest,
