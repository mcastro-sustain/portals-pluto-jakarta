 ...
 * </div>
 *    
 * @see jakarta.portlet.PortletResponse the add and set properties methods of PortletResponse
 * @see jakarta.portlet.MimeResponse#MARKUP_HEAD_ELEMENT MimeResponse#MARKUP_HEAD_ELEMENT
 * @see jakarta.portlet.HeaderPortlet
 * 
 * @since 3.0
 */
...
public @interface HeaderMethod {
    ...
    * </div>
    * 
    * @see        jakarta.portlet.HeaderResponse#setContentType(String) HeaderResponse#setContentType
    * 
