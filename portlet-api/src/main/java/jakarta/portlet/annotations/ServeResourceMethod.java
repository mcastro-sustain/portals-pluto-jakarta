 ...
 * </div>
 * 
 * @see     jakarta.portlet.ResourceServingPortlet#serveResource(jakarta.portlet.ResourceRequest, jakarta.portlet.ResourceResponse) ResourceServingPortlet#serveResource
 * 
 * @since 3.0
 */
...
public @interface ServeResourceMethod {
    ...
    * </div>
    * 
    * @see        jakarta.portlet.ResourceResponse#setCharacterEncoding(String) ResourceResponse#setCharacterEncoding
    * 
    ...
    * </div>
    * 
    * @see        jakarta.portlet.ResourceResponse#setContentType(String) ResourceResponse#setContentType
    * 
    ...
    * </div>
    * 
    * @see        jakarta.portlet.PortletRequestDispatcher
    * @see        jakarta.portlet.PortletRequestDispatcher#include(jakarta.portlet.PortletRequest, jakarta.portlet.PortletResponse) PortletRequestDispatcher#include
    * 
