 ...
 * throws clause should be of type {@link jakarta.portlet.PortletException} or
 * {@link java.io.IOException}. 
 * Checked exceptions of any other type will be caught, wrapped with a PortletException, 
 * and rethrown.
 * </div>
 *    
 * @see jakarta.portlet.EventPortlet#processEvent(jakarta.portlet.EventRequest, jakarta.portlet.EventResponse) processEvent
 * 
 * @since 3.0
 */
