...
public interface PortalContext
{
     ...
     * <p>
     * The value is <code>"jakarta.portlet.markup.head.element.support"</code>.
     *
     * @since 2.0
     */
	public static final String MARKUP_HEAD_ELEMENT_SUPPORT = "jakarta.portlet.markup.head.element.support";
