...
public class PortletResponseWrapper implements PortletResponse {
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.PortletResponse#getProperty(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.PortletResponse#getPropertyValues(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.PortletResponse#getPropertyNames()
    */
   @Override
