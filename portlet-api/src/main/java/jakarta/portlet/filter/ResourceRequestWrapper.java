...
public class ResourceRequestWrapper extends ClientDataRequestWrapper implements ResourceRequest {
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.ResourceRequest#startPortletAsync()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.ResourceRequest#isAsyncStarted()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.ResourceRequest#isAsyncSupported()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.ResourceRequest#getPortletAsyncContext()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.ResourceRequest#getDispatcherType()
    */
   @Override
