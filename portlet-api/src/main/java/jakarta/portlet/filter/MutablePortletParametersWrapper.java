...
import jakarta.portlet.Mutable;
...
public class MutablePortletParametersWrapper extends PortletParametersWrapper implements MutablePortletParameters,
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.MutablePortletParameters#setValue(java.lang.String, java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.MutablePortletParameters#setValues(java.lang.String, java.lang.String[])
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.MutablePortletParameters#removeParameter(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.MutablePortletParameters#set(jakarta.portlet.PortletParameters)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.MutablePortletParameters#add(jakarta.portlet.PortletParameters)
    */
   @Override
