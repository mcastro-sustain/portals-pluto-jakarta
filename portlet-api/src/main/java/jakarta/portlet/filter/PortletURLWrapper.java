...
public class PortletURLWrapper extends BaseURLWrapper implements PortletURL {
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.PortletURL#removePublicRenderParameter(java.lang.String)
    */
   @Deprecated
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.PortletURL#setBeanParameter(jakarta.portlet.annotations.PortletSerializable)
    */
   @Override
