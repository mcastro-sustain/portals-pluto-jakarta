...
public class MutableRenderParametersWrapper extends MutablePortletParametersWrapper implements MutableRenderParameters {
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.RenderParameters#clone()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.RenderParameters#isPublic(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.MutableRenderParameters#clearPrivate()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.MutableRenderParameters#clearPublic()
    */
   @Override
