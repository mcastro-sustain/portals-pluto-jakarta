...
public class PortalContextWrapper implements PortalContext {
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.PortalContext#getProperty(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.PortalContext#getPropertyNames()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.PortalContext#getSupportedPortletModes()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.PortalContext#getSupportedWindowStates()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.PortalContext#getPortalInfo()
    */
   @Override
