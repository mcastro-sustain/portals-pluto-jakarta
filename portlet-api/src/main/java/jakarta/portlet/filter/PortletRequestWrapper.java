...
public class PortletRequestWrapper extends RenderStateWrapper implements PortletRequest {
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.PortletRequest#getRenderParameters()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.PortletRequest#getPortletContext()
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.PortletRequest#getUserAgent()
    */
   @Override
