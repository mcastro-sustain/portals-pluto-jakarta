...
public class HeaderResponseWrapper extends MimeResponseWrapper implements HeaderResponse {
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.HeaderResponse#setTitle(java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.HeaderResponse#addDependency(java.lang.String, java.lang.String, java.lang.String)
    */
   @Override
   ...
   /* (non-Javadoc)
    * @see jakarta.portlet.HeaderResponse#addDependency(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
    */
   @Override
