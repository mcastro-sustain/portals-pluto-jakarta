...
public interface PortletRequest extends RenderState
{
   ...
   * <p>
   * The value is <code>jakarta.portlet.userinfo</code>.
   */
  public static final String USER_INFO = "jakarta.portlet.userinfo";
   ...
   * <p>
   * The value is <code>jakarta.portlet.ccpp</code>.
   * 
   * @since 2.0
   */
  public static final String CCPP_PROFILE = "jakarta.portlet.ccpp";
   ...
   * <p>
   * The value of the constant is <code>jakarta.portlet.lifecylce_phase</code>.
   * 
   * @since 2.0
   */
  public static final String LIFECYCLE_PHASE = "jakarta.portlet.lifecycle_phase";
   ...
   * <p>
   * The value of the constant is <code>jakarta.portlet.render_part</code>.
   * 
   *  @since 2.0
   */
  public static final String RENDER_PART = "jakarta.portlet.render_part";
   ...
   * if the <code>jakarta.portlet.actionScopedRequestAttributes</code>
   * container runtime option is used by the portlet.
   * <p>
   * The value is <code>jakarta.portlet.as</code>.
   * @since 2.0
   */
  public static final String ACTION_SCOPE_ID = "jakarta.portlet.as";
